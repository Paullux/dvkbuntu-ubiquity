...
mixer.init(16050)
pathSonWave = os.environ['HOME'] + '/.local/share/dvkbuntu/sonEnCours.wav'
...
class PageKde(plugin.PluginUI):
    ...
    def __init__(self, controller, *args, **kwargs):
        ...
        try:
            ...
            subprocess.call(['/usr/bin/createWaveFromItem', 'configuration du clavier'])
            Son = mixer.Sound(pathSonWave)
            Son.play(0)
    ...
    def on_keyboard_layout_selected(self, *args):
        ...
        if layout is not None:
            ...
            if self.keyboardDisplay:
                ...
                subprocess.call(['/usr/bin/createWaveFromItem', title + ' ' + message])
                Son = mixer.Sound(pathSonWave)
                Son.play(0)
